...
public class Home {
    ...
    public String Agregarbackpack() throws InterruptedException {
    ...
    @Step  // se añaden dos productos al carrito
    public String Agregarjacket() throws InterruptedException {
        WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(15));
    ...
    @Step  // se validan dos productos al carrito
